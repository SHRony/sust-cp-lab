...
export function LandingLamp() {
  return (
    <LampContainer className="gap-8">
      ...
      >
        SUST  <br /> Competetive programming lab
      </motion.h1>
      <motion.div>
      ...
      <motion.div>
        <Link href="/dashboard">
          <motion.button className="translate-y-24 mt-24 border border-slate-500 rounded-full py-4 px-8 text-white bg-white bg-opacity-10 hover:bg-opacity-20">
            Get started
          </motion.button>
        </Link>
      </motion.div>
